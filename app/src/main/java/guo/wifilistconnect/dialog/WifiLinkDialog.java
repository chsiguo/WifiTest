...
public class WifiLinkDialog extends Dialog implements View.OnClickListener{
    ...
    public WifiLinkDialog(@NonNull Context context, @StyleRes int themeResId, String text_nameString, String capabilities) {
        ...
        this.text_nameString = text_nameString;//ssid
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.cofirm_button:{
                ...
                Log.d("mypass"," cofirm_button: "+tempConfig+" mmSSID:"+text_nameString);
                if(tempConfig == null){//没有配置过这个网络
                    Log.d("mypass"," SSID: "+text_nameString+" password: "+password_edit.getText().toString()+" encry: "+WifiSupport.getWifiCipher(capabilities));
